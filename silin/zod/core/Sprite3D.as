...
package silin.zod.core
{
	...
	public class Sprite3D extends Sprite
	{
		...
		{ 
			...
			return sortingPriority * distance;//sortingPriority - костыль для одного мутного случая, а вообще 1
		...
		{ 
			//return stage ? Utils3D.projectVector(transform.getRelativeMatrix3D(root), ORIGIN ) : null;
			return stage ? transform.getRelativeMatrix3D(root).position : null;
